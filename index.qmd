...
## Líneas de investigación {background-image="img/Diapositiva2.PNG"}
...
## Actores frecuentes y relevantes {background-image="img/Diapositiva2.PNG"}
...
actores_FrecRel ={
  "actor": ["Comunidades rurales y locales",
            ...
            "Juventudes y población escolar",
            "Pueblos indígenas",
            "Usuarios del agua (agrícolas, domésticos, industriales)",
            "Entidades tecnológicas / desarrolladores"],
  "participacion": ["Agroecología, conservación comunitaria, gestión del agua, restauración ecológica, justicia socioambiental",
                    "Conservación de biodiversidad, manejo forestal, participación en políticas, gobernanza del agua",
                    "Todos los temas (desarrollo de metodologías, sistemática de insectos, tecnologías de monitoreo, estudios socioecológicos)",
                    "Políticas ambientales, ordenamiento territorial, justicia socioambiental, restauración, manejo del paisaje",
                    "Apoyo en conservación, gestión de recursos, fortalecimiento comunitario, monitoreo ambiental",
                    "Agroecología, innovación productiva, seguridad alimentaria, uso sustentable del suelo y del agua",
                    "Educación socioambiental, herramientas participativas, cambio cognitivo hacia la sustentabilidad",
                    "Educación ambiental, herramientas lúdicas, concientización sobre cambio climático y biodiversidad",
                    "Conservación basada en saberes tradicionales, manejo del territorio, gobernanza del agua y biodiversidad",
                    "Gestión y justicia hídrica, seguridad del recurso, participación en cuencas",
                    "Aplicación de IA, sensores, percepción remota, monitoreo ambiental"]}
...
## Grupos clave (mínimalista) {background-image="img/Diapositiva2.PNG" style="text-align: center;"}
...
actores_clave = {"actores": ["Gubernamentales", "Académicos", "Comunidades rurales", 
                             "Indígenas", "Jóvenes", "Mujeres"] }
...
## Grupos Transversales Clave {background-image="img/Diapositiva2.PNG"}
...
## Algunos detalles a considerar {background-image="img/Diapositiva2.PNG" .smaller}

\ 

+ Comunidades rurales e indígenas: 
  + Aunque su influencia institucional es baja, su potencial es alto y su papel en la ejecución de proyectos es fundamental → clave empoderarlas.

+ Gobiernos y universidades: 
  + Actores con capacidad técnica y decisional
...
## Relaciones indirectas {background-image="img/Diapositiva2.PNG" .smaller}

Algunos actores externos (como turismo, sector inmobiliario) parecen estar al margen de nuestros intereses comunes y potencial de influencia. Entre las razones que llevan a esta apreciación están las siguientes: 
...
En una versión más estratégica podríamos considerar vínculos de vigilancia o conflicto potencial, especialmente desde:

+ Comunidades locales → Actores externos (por impacto territorial).
+ Gobiernos / ONGs → Actores externos (regulación o migración de impactos).



## Resumen de Relevancia {background-image="img/Diapositiva2.PNG"}
### *(¿popularidad?)*
...
relevancia = {
  "nivel": ["Muy alta",
            ...
            "Media",
            "Moderada"],
  "temas": ["Cambio climático, restauración y monitoreo con IA — reciben la mayoría de las publicaciones y financiación",
"Conservación comunitaria, gestión del agua y NbS — con fuerte respaldo institucional y agendas globales",
"Políticas socioambientales y estudios sociocognitivos — en ascenso interdisciplinar, con creciente relevancia social",
"Sistemática de insectos — campo especializado, pero beneficiado por tendencias tecnológicas"]}
...
estilo = relevancia_df.style.set_table_styles([
                     ...
                     .hide() \
                     .set_properties(**{'font-size': '1.5rem'}) \
                     .relabel_index(["Relevancia", "Líneas"], axis=1)
...
## Distancia "semántica" entre temas {background-image="img/Diapositiva2.PNG" style="fig-align: center;"}
...
## Relevancia vs originalidad {background-image="img/Diapositiva2.PNG"}
...
## {background-image="img/Diapositiva2.PNG"}
...
## Matriz de actores-interés {background-image="img/Diapositiva2.PNG"}
...
# Etiquetas y título
ax.set_title("Matriz de Interés - Influencia de Actores Clave", fontsize=24)
...
# Cuadrantes
ax.text(7, 9.5, "Gestión cercana", fontsize=11, color='green')
ax.text(1, 9.5, "Apoyo / Empoderamiento", fontsize=11, color='blue')
ax.text(7, 0.5, "Monitoreo estratégico", fontsize=11, color='orange')
ax.text(1, 0.5, "Seguimiento mínimo", fontsize=11, color='gray')
...
## Dendrograma de las líneas {background-image="img/Diapositiva2.PNG" style="text-align: center;"}
...
## Mapa conceptual {background-image="img/Diapositiva2.PNG" style="fig-align: center;"}
####  Temas agrupados por cercanía semántica (Clusters)
...
for cluster in df_clusters["Cluster"].unique():
    ...
    nx.draw_networkx_nodes(G_conceptual, 
                           pos, 
...
nx.draw_networkx_edges(G_conceptual, pos, width=5, edge_color="silver", style="solid" )
...
## DAG: Relaciones entre actores {background-image="img/Diapositiva2.PNG" style="fig-lign: center;"}
...
## Tres grupos síntesis... {background-image="img/Diapositiva2.PNG"  .smaller}
 

#### 🟢 **Cluster 1: Restauración, conservación y justicia territorial**
...
**Descripción:**
Este grupo representa una agenda profundamente anclada en el territorio y la relación sociedad-naturaleza. Aquí convergen acciones prácticas de conservación ecológica con marcos de justicia y gobernanza ambiental. Tienen un enfoque integral que combina conocimientos técnicos, sistemas normativos, prácticas tradicionales y participación social.
...
#### 🔵 **Cluster 2: Enfoques tecnosociales para la sustentabilidad**
...
**Descripción:**
Este cluster se caracteriza por el **uso de herramientas innovadoras** –sociales y tecnológicas– aplicadas a la sustentabilidad. Los estudios sociocognitivos promueven la integración de saberes y la participación comunitaria, mientras que el monitoreo ambiental introduce tecnologías emergentes (IA, sensores, drones) para seguimiento ecológico. Es el más metodológicamente diverso y abierto a la innovación.

**Actores clave:**

* Instituciones académicas
* Gobiernos técnicos
* Jóvenes y colectivos sociales
* ONGs con enfoque en participación y tecnología

**Relevancia en México:** Alta

**Originalidad:** Muy alta, especialmente por sus métodos y su apertura a la innovación social y tecnológica.
...
#### 🔴 **Cluster 3: Cambio global y sistemas ecológicos complejos**
...
**Descripción:**
Este grupo aborda temas más **sistémicos, biofísicos y globales**. Involucra la modelación de procesos complejos como el cambio climático, la gestión de recursos hídricos y la biodiversidad estructural. Aunque algunos enfoques están consolidados, su integración es fundamental para diseñar políticas basadas en evidencia ecológica.

**Actores clave:**

* Gobiernos y agencias técnicas
* Centros de investigación
* Productores rurales (por implicación indirecta)
* Comunidades afectadas por sequía o cambio climático

**Relevancia en México:** Muy alta

**Originalidad:** Media (alta en integración, moderada en enfoques disciplinares clásicos)
...
# Material complementario {background-image="img/Diapositiva2.PNG"}
...
## Temas y Actores Transversales {background-image="img/Diapositiva2.PNG" style="text-align: center;"}
...
## DAG: Relación entre Temas y Actores {background-image="img/Diapositiva2.PNG"}
...
## Temas reformulados {background-image="img/Diapositiva2.PNG" .smaller}
...
## {background-image="img/Diapositiva2.PNG" .smaller}
...
## {background-image="img/Diapositiva3.PNG"}

[Gracias]{.absolute top="55%" left="55%" style="color: #4fbd8b; font-size: 3em;"} <!-- #4a67cb -->
