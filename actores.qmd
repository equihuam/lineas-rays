...
## Grupos clave (mínimalista) {style="text-align: center;"}
...
En una versión más estratégica podríamos considerar vinculos de vigilancia o conflicto potencial, especialmente desde:
...
## Distancia "semántica" entre temas {style="fig-align: center;"}
...
for actor, (interes, influencia) in actores.items():
    ...
    ax.text(interes + 0.2, influencia, actor, fontsize=11)
...
## Dendrograma de las líneas {style="text-align: center;"}
...
+ Conservación y manejo comunitario de la biodiversida 
+ Evaluación ambiental, restauración y manejo de ecosistemas
+ Políticas y justicia socioambiental
...
![](img/ChatGPT Image 18 jun 2025, 10_14_11 p.m..png){width=44     0}
:::
...
## DAG: Relación entre Temas y Actores
