...
sns.heatmap(dist_df_nuevos, annot=True, cmap="YlGnBu", xticklabels=True, yticklabels=True)
...
plt.title("Relevancia vs. Originalidad de Temas (sin traslape)")
plt.xlabel("Relevancia (1-10)")
plt.ylabel("Originalidad (1-10)")
plt.xlim(5.5, 9.5)
plt.ylim(5.5, 9.5)
plt.grid(True)
